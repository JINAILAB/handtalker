...
for i in range(10, 71, 10):  # 이미지의 숫자 범위에 맞게 반복문 설정
    left_image_path = f"./res_hand_pose_image/pose_left0{i}.png"
    right_image_path = f"./res_hand_pose_image/pose_right0{i}.png"
...
for idx, (left_image_path, right_image_path) in enumerate(image_files):
    ...
    # 합성된 이미지 저장
    output_path = f"./res_hand_pose_image/pose_both_{(idx+1)*10}.png"
